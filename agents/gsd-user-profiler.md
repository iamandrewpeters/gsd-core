...
<reference>
@${CLAUDE_PLUGIN_ROOT}/gsd-core/references/user-profiling.md
...
Read the user-profiling reference document at `${CLAUDE_PLUGIN_ROOT}/gsd-core/references/user-profiling.md` to load:
