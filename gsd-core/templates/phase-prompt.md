...
<!-- For checkpoint task examples and patterns, see @${CLAUDE_PLUGIN_ROOT}/gsd-core/references/checkpoints.md -->
...
See `${CLAUDE_PLUGIN_ROOT}/gsd-core/references/tdd.md` for TDD plan structure.
...
See `${CLAUDE_PLUGIN_ROOT}/gsd-core/templates/user-setup.md` for full schema and examples
...
See `${CLAUDE_PLUGIN_ROOT}/gsd-core/workflows/verify-phase.md` for verification logic.
