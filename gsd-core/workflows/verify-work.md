...
<template>
@${CLAUDE_PLUGIN_ROOT}/gsd-core/templates/UAT.md
</template>
...
**MVP-mode UAT framing.** When `MVP_MODE=true`, follow the rules in `@${CLAUDE_PLUGIN_ROOT}/gsd-core/references/verify-mvp-mode.md`. Briefly:
...
Read and follow `${CLAUDE_PLUGIN_ROOT}/gsd-core/workflows/transition.md`.
...
- Follow @${CLAUDE_PLUGIN_ROOT}/gsd-core/workflows/diagnose-issues.md
